...
/*
 * Connect4SpotBoard is a user interface component that implements SpotBoard.
 * 
...
public class Connect4SpotBoard extends JPanel implements SpotBoard {
	...
	private static final Color DEFAULT_SPOT_COLOR = Color.YELLOW;
	private static final Color DEFAULT_HIGHLIGHT_COLOR = Color.YELLOW;

	private Spot[][] _spots;
	
	public Connect4SpotBoard(int width, int height) {
...
//			System.out.println(getSpotWidth());
//			System.out.println(getSpotHeight());
