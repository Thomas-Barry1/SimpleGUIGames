...
/*
 * TicSpotBoard is a user interface component that implements SpotBoard.
 * 
...
public class TicSpotBoard extends JPanel implements SpotBoard {
	...
	public TicSpotBoard(int width, int height) {
